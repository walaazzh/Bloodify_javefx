...
public class PasswordController {
    ...
    private boolean validateCurrentPassword(String currentPassword) {
        ...
        String storedHashedPassword = currentUser.getPassword(); // Get the hashed password from the current user

        // Use BCrypt to verify if the current password matches the stored hashed password
        boolean passwordMatches = BCrypt.verifyer().verify(currentPassword.toCharArray(), storedHashedPassword).verified;
